                          ...
                          child: AppCard(
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        fontWeight: FontWeight.bold,
                                        color:
                                            pur.status == PurchaseStatus.paid
                                                ? Colors.green
                                                : Colors.orange,
                                      ),
                                    ),
                                ...
                                Text(
                                  'Supplier: ${pur.supplierName} • Ref: ${pur.supplierInvoiceNumber}',
                                ),
                                Text(
                                  'Date: ${pur.purchaseDate.day}/${pur.purchaseDate.month}/${pur.purchaseDate.year}',
                                ),
                                const Divider(),
                                Row(
                                  mainAxisAlignment:
