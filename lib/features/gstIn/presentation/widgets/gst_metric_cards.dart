        ...
        return Wrap(
          ...
          children: [
            ...
            SizedBox(
              width: cardWidth,
              child: InkWell(
                onTap: () => ref.read(gstActiveTabProvider.notifier).setTab('Returns'),
            ...
            SizedBox(
              ...
              child: _buildStandardMetricCard(
                ...
                onTap: () => ref.read(gstActiveTabProvider.notifier).setTab('Payments'),
                isDark: isDark,
              ),
            ),
            ...
            SizedBox(
              ...
              child: _buildStandardMetricCard(
                ...
                onTap: () => ref.read(gstActiveTabProvider.notifier).setTab('Ledger'),
                isDark: isDark,
              ),
            ),
            ...
            SizedBox(
              ...
              child: _buildStandardMetricCard(
                ...
                onTap: () => ref.read(gstActiveTabProvider.notifier).setTab('Compliance'),
                isDark: isDark,
              ),
            ),
            ...
            SizedBox(
              ...
              child: _buildStandardMetricCard(
                ...
                onTap: () => ref.read(gstActiveTabProvider.notifier).setTab('GSTIN Details'),
                isDark: isDark,
              ),
            ),
          ],
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 10.5,
                          color: subtitle == 'View details'
                              ? const Color(0xFF15803D)
                              : (isDark ? Colors.white38 : const Color(0xFF94A3B8)),
                          fontWeight: subtitle == 'View details' ? FontWeight.bold : FontWeight.normal,
                        ),
                        overflow: TextOverflow.ellipsis,
                      ),
                    ],
