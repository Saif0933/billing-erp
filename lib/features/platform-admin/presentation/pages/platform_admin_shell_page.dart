...
class PlatformAdminShellPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PlatformAdminShellPage> createState() =>
      _PlatformAdminShellPageState();
}

class _PlatformAdminShellPageState
    extends ConsumerState<PlatformAdminShellPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.initialTab != null &&
        widget.initialTab != state.selectedNavTab) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        notifier.setNavTab(widget.initialTab!);
      });
    }
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) {
        ...
        if (state.selectedNavTab != 'dashboard') {
                    ...
                    if (action == 'logout') {
                      ...
                      if (context.mounted) {
                        AppFeedback.showSnackbar(
                          context,
                          message: 'SuperAdmin signed out successfully.',
                        );
                        context.go('/login');
                      }
      ...
      child: Row(
        children: [
          Icon(
            icon,
            size: 18,
            color: isGreen ? const Color(0xFF16A34A) : const Color(0xFF4F46E5),
          ),
          const SizedBox(width: 10),
          Expanded(
            child: Column(
